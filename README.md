...
## Overview
Your group is tasked to build an e-commerce site. You will be building an express/postgres backend and a react frontend, which will live in separate repos on github and separate deployments on heroku.

## Planning
Before you start writing code, plan out the following items. Show them to your pod leader for feedback!
...
1. I can create an account, log in, and log out
